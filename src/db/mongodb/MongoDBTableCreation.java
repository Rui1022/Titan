...
public class MongoDBTableCreation {
	...
	public static void main(String[] args) throws ParseException {
		MongoClient mongoClient = new MongoClient(); // create client
		...
		db.getCollection("items").createIndex(new Document().append("description", "text").append("snippet", "text")
				.append("address", "text").append("name", "text"));
